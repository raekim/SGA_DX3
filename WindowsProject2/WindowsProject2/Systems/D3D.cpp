...
void D3D::CreateSwapChainAndDevice()
{
	...
	{
		// DX 11.1 은 Windows SDK 에 포함되어 있음
		// Window 8 에서만 지원이라는 논란이 있음
		// Direct2D 가 버전업되어 처리효율이 5배나 강화됨 (일부 XNA 기능이 탑재됨)
		// DX 11 대의 최신 버전은 DirectX 11.4(2019년)
		// DX 12 대의 최초 등장은 2015년
